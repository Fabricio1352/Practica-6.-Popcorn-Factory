...
class catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        series.add(Pelicula("Smalville",R.drawable.adorabledemonio ,R.drawable.adorabledemonios , "La leyenda de Aang sigue al último sobreviviente de los Nómadas del Aire, quien deberá restaurar el equilibrio en el mundo entre las tres naciones restantes: la Tribu del Agua, el Reino Tierra y la Nación del Fuego."))
        series.add(Pelicula("Dr. Who",R.drawable.ant ,R.drawable.ant , "Una evacuación mortal cambia la guerra del Jefe Maestro con el Covenant. En Reach, un nuevo régimen toma el mando en FLEETCOM. John siente una amenaza inminente cerca. Estreno de temporada."))
        ...
        series.add(Pelicula("Dr. House",R.drawable.dune ,R.drawable.dune , "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos."))
        series.add(Pelicula("Friends ",R.drawable.halos ,R.drawable.thewitcher , "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
